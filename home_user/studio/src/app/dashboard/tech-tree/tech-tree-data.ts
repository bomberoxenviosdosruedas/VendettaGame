...
export const troopsTechData: TechItem[] = [
  {
    id: "maton",
    name: "Matón",
    image: "troop-maton",
  ...
  },
  {
    ...
    image: "troop-portero",
    available: false,
    requirements: [{ name: "Extorsión", level: 2 }],
  },
  {
    id: "acuchillador",
    name: "Acuchillador",
    image: "troop-acuchillador",
    available: false,
    requirements: [{ name: "Extorsión", level: 4 }],
  },
  {
    id: "pistolero",
    name: "Pistolero",
    image: "troop-pistolero",
    available: false,
    requirements: [{ name: "Entrenamiento de Tiro", level: 2 }],
  },
  {
    id: "tropa-ocupacion",
    name: "Tropa de Ocupación",
    image: "troop-ocupacion",
    available: false,
    requirements: [{ name: "Planificación de rutas", level: 5 }],
  },
  {
    id: "espia",
    name: "Espía",
    image: "troop-espia",
    available: false,
    requirements: [{ name: "Espionaje", level: 2 }],
  },
  {
    id: "porteador",
    name: "Porteador",
  ...
  {
    id: "agente-cia",
    name: "Agente de la CIA",
    image: "troop-cia",
    available: false,
    requirements: [
        { name: "Entrenamiento de guerrilla", level: 3 },
        { name: "Planificación de encargos", level: 3 },
    ],
  },
  {
    id: "agente-fbi",
  ...
  },
  {
    id: "transportista",
    name: "Transportista",
    image: "troop-transportista",
    available: false,
    requirements: [{ name: "Entrenamiento psicológico", level: 4 }],
  },
  {
    id: "experto-tactico",
    name: "Experto Táctico",
    image: "troop-tactico",
    available: false,
    requirements: [
        { name: "Entrenamiento de Tiro", level: 5 },
        { name: "Entrenamiento Químico", level: 3 },
    ],
  },
  {
    id: "francotirador",
    name: "Francotirador",
    image: "troop-francotirador",
    available: false,
    requirements: [
        { name: "Entrenamiento psicológico", level: 5 },
        { name: "Entrenamiento de guerrilla", level: 5 },
    ],
  },
  {
    id: "asesino",
    ...
    available: false,
    requirements: [
        { name: "Entrenamiento psicológico", level: 7 },
        { name: "Protección de grupo", level: 7 },
    ],
  },
  {
    id: "ninja",
    ...
    image: "troop-ninja",
    available: false,
    requirements: [{ name: "Entrenamiento de guerrilla", level: 8 }],
  },
  {
    id: "experto-demoliciones",
    name: "Experto en Demoliciones",
    image: "troop-demoliciones",
    available: false,
    requirements: [
        { name: "Fabricación de explosivos", level: 6 },
        { name: "Entrenamiento Químico", level: 8 },
    ],
  },
  {
    id: "mercenario",
    name: "Mercenario",
    image: "troop-mercenario",
    available: false,
    requirements: [
        { name: "Entrenamiento de guerrilla", level: 9 },
        { name: "Combate cuerpo a cuerpo", level: 9 },
        { name: "Protección de grupo", level: 9 },
    ],
  },
];
