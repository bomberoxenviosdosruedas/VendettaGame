...
-- These functions perform inserts into queue tables but were missing SECURITY DEFINER
-- leading to RLS violations when called by users without direct INSERT permissions.
